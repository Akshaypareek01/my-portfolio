    ...
    return (
        <Container id='contact'>
                ...
                <div className='contactText'>
                    ...
                    <div className='middleSection'>
                        <div>
                            ...
                            <a href="https://www.linkedin.com/in/akshay-pareek-377435216" rel="noreferrer" target="_blank">
                                <p>Akshay Pareek</p>
                            </a>
                        </div>
                        <div>
                            ...
                            <a href="tel:+918290918154" rel="noreferrer" target="_blank">
                                <p>+918290918154</p>
                            </a>
                        </div>
                        <div>
                            ...
                            <a href='mailto:akshaypareek.work@gmail.com' rel="noreferrer" target="_blank"><p>akshaypareek.work@gmail.com</p></a>
                        </div>
                        <div>
                            <LocationOnIcon fontSize="large" />
                            <h1>Location</h1>
                            <p>Parbatsar,Rajasthan</p>
                            <a  href="https://www.google.com/maps/place/Parbatsar,+Rajasthan+341512/@26.886287,74.7596884,1519m/data=!3m2!1e3!4b1!4m5!3m4!1s0x396b90116de007c1:0xef2c230bdf45d1ef!8m2!3d26.8856982!4d74.7644289" rel="noreferrer" target="_blank">
            ...
            <div className='endSection'>
                <p>© 2022 akshay. Design by Me with <FavoriteIcon sx={{ color: '#01a479' }} /></p>
            </div>
        </Container>
    )
}
